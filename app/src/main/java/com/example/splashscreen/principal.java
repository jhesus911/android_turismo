...
public class principal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new lugares(R.drawable.registro, "Centro Historico", 100));
        items.add(new lugares(R.drawable.termales, "Zona Rural", 105));
        items.add(new lugares(R.drawable.deportes, "Deportes", 160));
        items.add(new lugares(R.drawable.parapente1, "Parapente",185));
        items.add(new lugares(R.drawable.restaurante1, "Restaurantes",162));
        items.add(new lugares(R.drawable.gastronomia, "gastronomia",115));
        // Obtener el Recycler
